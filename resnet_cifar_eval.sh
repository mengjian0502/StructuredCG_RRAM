...
log_file="${model}_optim${optimizer}_lr${lr}_wd${wd}_eval.log"

pretrained_model="./save/strucCG/resnet20_CG/resnet20_CG_optimSGD_lr0.1_wd0.0005_cg2_cg_slideTrue_4bit/model_best.pth.tar"
